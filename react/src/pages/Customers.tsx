                    ...
                    <tr key={cust.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                        <div className="group relative flex items-center">
                          <span className="font-mono text-xs">{cust.id.substring(0, 8)}...</span>
                          <button
                            onClick={() => {
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="group relative flex items-center">
                          ...
                          <button
                            onClick={() => {
                              navigator.clipboard.writeText(cust.cpf);
                              notificationService.success('CPF Copiado!', 'O CPF foi copiado para a área de transferência.');
                            }}
                            className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-200 rounded"
                            title="Copiar CPF"
                          >
